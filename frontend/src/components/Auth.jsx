...
const Auth = () => {
  ...
  // Initialize Google Identity Services (GIS) ID token flow & Render Native Button
  useEffect(() => {
    const initGIS = () => {
            ...
            {!isRecoveryMode ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="w-full flex flex-col items-center justify-center gap-2">
                  <div ref={googleBtnContainerRef} className="min-h-[42px] flex items-center justify-center w-full" />
                </div>
