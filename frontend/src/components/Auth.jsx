              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="pt-2 space-y-2.5">
                  ...
                  <button
                    ...
                    disabled={loading || accessGranted}
                    className="w-full py-3.5 px-4 rounded-2xl bg-[#080d17] border border-slate-700/80 hover:border-emerald-500/60 hover:bg-[#111a2c] text-slate-200 text-xs font-semibold transition-all flex items-center justify-center gap-2.5 shadow-sm active:scale-[0.99] group cursor-pointer"
                  >
                    ...
                    <span>Sign in with Google (jayedurnirob@gmail.com)</span>
                  </button>
                </div>
